...
CREATE TABLE public.system_settings (
  ...
  notify_customer_creation_super_admins BOOLEAN NOT NULL DEFAULT true,
  notify_customer_creation_technician BOOLEAN NOT NULL DEFAULT true,
  notify_customer_creation_additional_emails BOOLEAN NOT NULL DEFAULT true,
  notify_amendment_super_admins BOOLEAN NOT NULL DEFAULT true,
  notify_amendment_technician BOOLEAN NOT NULL DEFAULT true,
  notify_amendment_additional_emails BOOLEAN NOT NULL DEFAULT true,
  amendment_notification_emails TEXT[] NOT NULL DEFAULT '{}',
  notify_comment_super_admins BOOLEAN NOT NULL DEFAULT true,
  notify_comment_technician BOOLEAN NOT NULL DEFAULT true,
  notify_comment_additional_emails BOOLEAN NOT NULL DEFAULT true,
  comment_notification_emails TEXT[] NOT NULL DEFAULT '{}',
